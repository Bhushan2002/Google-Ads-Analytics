...
export default function DashboardView({ isConnected = true }: DashboardViewProps) {
  ...
  const fetchData = async (id: string) => {
    ...
    const overviewUrl = `${API_BASE}/ads/overview/${id}`
    const campaignsUrl = `${API_BASE}/ads/campaigns/${id}`
    ...
    try {
      ...
      if (!overviewRes.ok || !overviewJson.success) {
        ...
        throw new Error(overviewJson.message || overviewJson.error || 'Failed to fetch overview')
      }
      if (!campaignsRes.ok || !campaignsJson.success) {
        setErrorType(campaignsJson.errorType || null)
        throw new Error(campaignsJson.message || campaignsJson.error || 'Failed to fetch campaigns')
      }
  ...
  const handleConnect = async () => {
    try {
      ...
      toast.error('Failed to reach backend. Is the server running on port 9000?')
    }
  }
    ...
    <div className="min-h-screen bg-gray-50/70">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Google Ads Analytics</h1>
            <p className="text-sm text-gray-400 mt-0.5">Campaign performance overview</p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-6">
        {!isConnected ? (
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-12 max-w-md mx-auto mt-10 text-center">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-2">Connect Google Ads</h2>
          ...
          <>
            ...
            {error && !loading && (
              <div className={`rounded-xl border p-6 text-center shadow-sm ${
                errorType === 'DEVELOPER_TOKEN_RESTRICTED' || errorType === 'MANAGER_ACCOUNT' || errorType === 'NO_CLIENT_ACCOUNTS'
                ...
                {errorType === 'DEVELOPER_TOKEN_RESTRICTED' ? (
                  <>
                    ...
                    <div className="bg-yellow-100 rounded-lg p-4 text-left text-sm text-yellow-800 space-y-2 max-w-2xl mx-auto">
                      <p className="font-semibold">To access your data, you need to:</p>
                      <ol className="list-decimal list-inside space-y-1 ml-2">
                        <li>Use a <strong>Google Ads Test Account</strong> (Manager account with test access)</li>
                        <li>OR apply for <strong>Basic/Standard access</strong> for your developer token at:
                          <a href="https://ads.google.com/aw/apicenter" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline ml-1">
                            Google Ads API Center
                          </a>
                        </li>
                      </ol>
                      <p className="text-xs text-yellow-600 mt-3 pt-2 border-t border-yellow-300">
                        💡 <strong>Note:</strong> During development, it's recommended to use a test account to avoid this restriction.
                      </p>
                    </div>
                  </>
                  ...
                  <>
                    ...
                    <div className="bg-yellow-100 rounded-lg p-4 text-left text-sm text-yellow-800 space-y-2 max-w-2xl mx-auto">
                      <p className="font-semibold">What are Manager Accounts?</p>
                      <p>
                        Manager accounts (also called MCC accounts) are used to manage multiple client accounts.
                        They don't have campaigns or metrics themselves.
                      </p>
                      <p className="font-semibold mt-2">To view your data:</p>
                      <ul className="list-disc list-inside space-y-1 ml-2">
                        <li>If you have <strong>client accounts</strong> under this manager, they should appear in the dropdown</li>
                        <li>If not, create a <strong>client account</strong> under your manager account in Google Ads</li>
                      </ul>
                    </div>
                  </>
                  ...
                  <>
                    ...
                    <div className="bg-yellow-100 rounded-lg p-4 text-left text-sm text-yellow-800 space-y-2 max-w-2xl mx-auto">
                      ...
                      <ol className="list-decimal list-inside space-y-1 ml-2">
                        ...
                        <li>Create a <strong>client account</strong> under your manager account</li>
                        <li>Make sure the account is <strong>enabled/active</strong></li>
            ...
            {!loading && !error && !overview && accounts.length === 0 && (
              <div className="bg-white rounded-xl border border-gray-200 p-16 text-center shadow-sm">
                ...
                <h2 className="text-xl font-semibold text-gray-800 mb-2">Fetching your accounts...</h2>
            ...
            {!loading && overview && (
              <>
                ...
                <OverviewCards totals={overview.totals} daily={overview.daily} />
                ...
                <h2 className="text-lg font-semibold text-gray-800 pt-2">Details</h2>
